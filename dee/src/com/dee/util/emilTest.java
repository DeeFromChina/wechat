...
public class emilTest {
   public static void sendEmail(Map<String, String> emailMap) throws MessagingException {
      try {
         ...
         String path = BaseController.FILE_PATH + "/properties/emailProperties.properties";
...
//      message.setRecipient(RecipientType.CC, bcc);
      ...
      message.setContent("尊敬的用户 [0]，您好：<p>[1]你有面试邀请状态更新，请登录网站确认面试信息。<br/>" +
      		"  <img src='"+BaseController.FILE_PATH+"/img/zhuanfa.png' /> <style type='text/css'>.hotline24{ width:60px; height:30px;border-radius: 5px; background:#eb2744; line-height:30px; text-align:center; color:#fff;font-size:13px;}</style>" +
