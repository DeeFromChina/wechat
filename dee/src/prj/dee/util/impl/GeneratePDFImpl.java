...
import prj.dee.util.ChinaInitial;
import prj.dee.util.GeneratePDF;
import prj.dee.util.SendEmail;
...
//	          PdfWriter writer= PdfWriter.getInstance(document, new FileOutputStream(BaseController.FILE_PATH+"\\pdf\\"+map.get("name").get(0).get("content")+".PDF"));

	          
	          
	          //设置字体
	          BaseFont bfChinese = BaseFont.createFont(BaseController.FILE_PATH+"/common/simyou.TTF", BaseFont.IDENTITY_H,BaseFont.NOT_EMBEDDED); 
	          ...
	          //页头信息左面  
//	          String imagePath01 = BaseController.FILE_PATH+"/img/U-Offerlogo.png";
...
//	          headAndFootPdfContent.addImage(image01);
	        ...
	        //table1
	          ...
	          String imagePath2 = BaseController.FILE_PATH+"/img/boder.jpg";
	          ...
	          File file=new File(BaseController.FILE_PATH+"/upload/photo/"+map.get("userId").get(0).get("content")+".jpg"); 
			  if(!file.exists())    
				{    String nameString = ChinaInitial.getPYIndexStr(map.get("name").get(0).get("content"), true);
					 personimagePath =  BaseController.FILE_PATH+"/img/font/"+nameString.toCharArray()[0]+".png";
				} else {
					personimagePath = BaseController.FILE_PATH+"/upload/photo/"+map.get("userId").get(0).get("content")+".jpg";
				}
	          ...
	          String imagePathskill = BaseController.FILE_PATH+"/img/boder.jpg";
	          ...
	          String imagePathsex = BaseController.FILE_PATH+"/img/boder.jpg";
	        ...
	        //教育经历
	          ...
	          String imagePathguwen = BaseController.FILE_PATH+"/img/boder.jpg";
...
//	          String imagePathsstex = BaseController.FILE_PATH+"/img/boder.jpg";
...
//	          document.add(blankRow1);
	          ...
	          String imagePathgeren = BaseController.FILE_PATH+"/img/boder.jpg";
