	...
	<form id="dataForm">
		<table class="login-top">
			...
			<tr>
				...
				<td>
					<input type="password" id="password" name="password" class="form-control" onkeydown="enter(event)">
				</td>
			</tr>
			<tr>
				<td/>
				<td>
					<div class="wi50 floatL">
			...
			<tr>
				<td/>
				<td>
					<button id="submit" type="button" class="btn btn-primary" onclick="goSubmit()">
						确认提交
					</button>
				</td>
			</tr>
